...
public class Body_TestPozitive extends BaseClass {
    ...
    public void returnLogin() throws IOException {
        ...
        assertEquals(user.getLogin(), "Catea13");
    ...
    public void returnID() throws IOException {
        ...
        response = client.execute(get);
        User user = ResponseUtils.unmarshall(response, User.class);
        assertEquals(user.getId(), 58842293);
    ...
    public void avatar_url() throws IOException {
        ...
        response = client.execute(get);
        User user = ResponseUtils.unmarshall(response, User.class);
        assertEquals(user.getAvantarUrl(), "https://avatars.githubusercontent.com/u/58842293?v=4");
    ...
    public void url() throws IOException {
        ...
        response = client.execute(get);
        User user = ResponseUtils.unmarshall(response, User.class);
        assertEquals(user.getUrl(), "https://api.github.com/users/Catea13");
    }
    ...
    public void followers_url() throws IOException {
        ...
        response = client.execute(get);
        User user = ResponseUtils.unmarshall(response, User.class);
        assertEquals(user.getFollowers_url(), "https://api.github.com/users/Catea13/followers");
    }
    ...
    public void gists_url() throws IOException {
        ...
        response = client.execute(get);
        User user = ResponseUtils.unmarshall(response, User.class);
        assertEquals(user.getGists_url(), "https://api.github.com/users/Catea13/gists{/gist_id}");
    }
    ...
    public void getStarred_url() throws IOException {
        ...
        response = client.execute(get);
        User user = ResponseUtils.unmarshall(response, User.class);
        assertEquals(user.getStarred_url(), "https://api.github.com/users/Catea13/starred{/owner}{/repo}");
    }
    ...
    public void subscriptions_url() throws IOException {
        ...
        response = client.execute(get);
        User user = ResponseUtils.unmarshall(response, User.class);
        assertEquals(user.getSubscriptions_url(), "https://api.github.com/users/Catea13/subscriptions");
    }
    ...
    public void organizations_url() throws IOException {
        ...
        response = client.execute(get);
        User user = ResponseUtils.unmarshall(response, User.class);
        assertEquals(user.getOrganizations_url(), "https://api.github.com/users/Catea13/orgs");
    }
    ...
    public void repos_url() throws IOException {
        ...
        response = client.execute(get);
        User user = ResponseUtils.unmarshall(response, User.class);
        assertEquals(user.getRepos_url(), "https://api.github.com/users/Catea13/repos");
    }
    ...
    public void Events_URL() throws IOException {
        ...
        response = client.execute(get);
        User user = ResponseUtils.unmarshall(response, User.class);
        assertEquals(user.getEvents_url(), "https://api.github.com/users/Catea13/events{/privacy}");
    }
    ...
    public void received_events_url() throws IOException {
        ...
        response = client.execute(get);
        User user = ResponseUtils.unmarshall(response, User.class);
        assertEquals(user.getReceived_events_url(), "https://api.github.com/users/Catea13/received_events");
    }
    ...
    public void site_admin() throws IOException {
        ...
        response = client.execute(get);
        User user = ResponseUtils.unmarshall(response, User.class);
        assertEquals(user.isSite_admin(), false);
    }
    ...
    public void twitter_username() throws IOException {
        ...
        response = client.execute(get);
        User user = ResponseUtils.unmarshall(response, User.class);
        assertEquals(user.getTwitter_username(), null);
    }
    @Test
    public void public_repos() throws IOException {
        ...
        response = client.execute(get);
        User user = ResponseUtils.unmarshall(response, User.class);
        assertEquals(user.getPublic_repos(), 35);
    }
    @Test
    public void public_gists() throws IOException {
        ...
        response = client.execute(get);
        User user = ResponseUtils.unmarshall(response, User.class);
        assertEquals(user.getPublic_gists(), 0);
    }
    @Test
    public void followers() throws IOException {
        ...
        response = client.execute(get);
        User user = ResponseUtils.unmarshall(response, User.class);
        assertEquals(user.getFollowers(), 0);
    }
    @Test
    public void following() throws IOException {
        ...
        response = client.execute(get);
        User user = ResponseUtils.unmarshall(response, User.class);
        assertEquals(user.getFollowing(), 0);
    }
    @Test
    public void CreatedAt() throws IOException {
        ...
        response = client.execute(get);
        User user = ResponseUtils.unmarshall(response, User.class);
        assertEquals(user.getCreated_at(), "2019-12-13T07:30:38Z");
    }
    @Test
    public void updated_at() throws IOException {
        ...
        response = client.execute(get);
        User user = ResponseUtils.unmarshall(response, User.class);
        assertEquals(user.getUpdated_at(), "2021-03-14T12:50:48Z");
    }
}
